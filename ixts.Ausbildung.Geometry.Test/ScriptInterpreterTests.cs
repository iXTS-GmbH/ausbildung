...
namespace ixts.Ausbildung.Geometry.Test
{
    ...
    class ScriptInterpreterTests
    {
        ...
        public static readonly object[] EvalMoveTestSource =
            {
                new object[] {"draw Triangle 20/20 40/20 30/40","move north 10","Triangle1",new Triangle(new[] {new Point(20, 30), new Point(40, 30), new Point(30, 50)})},//Noth
                new object[] {"draw Triangle 20/20 40/20 30/40","move east 10","Triangle1",new Triangle(new[] {new Point(30, 20), new Point(50, 20), new Point(40, 40)})},//East
                new object[] {"draw Triangle 20/20 40/20 30/40","move south 10","Triangle1",new Triangle(new[] {new Point(20, 10), new Point(40, 10), new Point(30, 30)})},//South
                new object[] {"draw Triangle 20/20 40/20 30/40","move west 10","Triangle1",new Triangle(new[] {new Point(10, 20), new Point(30, 20), new Point(20, 40)})}//West
            };
